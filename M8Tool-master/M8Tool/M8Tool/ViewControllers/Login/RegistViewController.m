...
- (void)viewDidLoad
{
    ...
    _checkPasswordTF.backgroundColor = WCWhite;
    _checkPasswordTF.layer.borderWidth = 0.5;
    _checkPasswordTF.layer.borderColor = WCGray.CGColor;
    ...
    registBtn.backgroundColor = WCRed;
    registBtn.layer.cornerRadius = 5.0;
    [registBtn setTitle:@"注册" forState:UIControlStateNormal];
    [registBtn setTitleColor:WCWhite forState:UIControlStateNormal];
    registBtn.titleLabel.attributedText = [CommonUtil customAttString:@"注册"
